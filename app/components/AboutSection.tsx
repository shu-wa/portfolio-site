        ...
        <div className="min-w-0 flex-1">
              ...
              <div className="mt-10 grid gap-5 md:grid-cols-2">
                <div className="rounded-3xl border border-slate-800 bg-slate-900 p-7">
                  ...
                  <p className="leading-8 text-slate-300">
                    プログラミング、データベース、信号処理、制御、UML、フーリエ解析など、
                    情報系・工学系の科目を学んでいます。
                  </p>
                </div>
                ...
                <div className="rounded-3xl border border-slate-800 bg-slate-900 p-7">
                  ...
                  <p className="leading-8 text-slate-300">
                    JavaとMySQLによる注文管理システム、Python/Pyxelによるゲーム、
                    Next.jsとAWSによるポートフォリオサイトなどを制作しました。
                  </p>
                </div>
              </div>
            </ScrollReveal>
          ...
          <section className="flex min-h-screen items-center py-24">
                <ScrollReveal direction="left" className="w-full">
                    ...
                    <h3 className="text-4xl font-bold md:text-5xl">ギターと音楽</h3>

                    <p className="mt-8 max-w-4xl text-lg leading-9 text-slate-300">
                    趣味の中でも特にギターが好きです。音楽は、コードやリズムのように
                    感覚的な面と理論的な面が重なっているところが面白いと感じています。
                    ...
                    <div className="rounded-3xl border border-slate-800 bg-slate-900 p-7">
                        ...
                        <p className="leading-8 text-slate-300">
                        ただ紹介文として書くだけでなく、実際に触れるUIとして表現することで、
                        自分らしさをWeb上のインタラクションに落とし込みました。
                        </p>
                    </div>
                    ...
                    <div className="rounded-3xl border border-slate-800 bg-slate-900 p-7">
                        ...
                        <p className="leading-8 text-slate-300">
                        音の高さはフレットごとに半音ずつ上がるため、クリック位置に応じて
                        周波数を変化させる仕組みにしています。
                        </p>
                    </div>
                    </div>
